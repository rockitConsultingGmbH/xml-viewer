...
def create_target_location_row(target_location, communication_id, location_type):
    return {
        ...
        'useLocalFilename': convert_checkbox_to_string(get_checkbox_value(f"use_local_filename_checkbox_target_{target_location[0]}")),
        'usePathFromConfig': convert_checkbox_to_string(get_checkbox_value(f"use_path_from_config_checkbox_target_{target_location[0]}")),
        'targetMustBeArchived': convert_checkbox_to_string(get_checkbox_value(f"target_must_be_archived_checkbox_{target_location[0]}")),
        'targetHistoryDays': convert_checkbox_to_string(get_checkbox_value(f"target_history_days_checkbox_{target_location[0]}")),
        'renameExistingFile': convert_checkbox_to_string(get_checkbox_value(f"rename_existing_file_checkbox_{target_location[0]}")),
