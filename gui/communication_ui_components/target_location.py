...
def create_target_location_form(label_children_style, communication_id):
    ...
    for targetLocation in targetLocations:
        add_target_location_fields(target_locations_form_layout, label_children_style, targetLocation, toggle_inputs)

    conn.close()
    return target_locations_form_layout


def add_target_location_fields(layout, label_children_style, targetLocation, toggle_inputs):
